...
* `tslsize` prints the size of the specification, i.e., the number of AST nodes
  ...
  benchmarks.
* `parsedot` processes the dot file generated by an LTL synthesis engine into a human readable form.
  Must be passed a dot file synthesized from a .tlsf file, which was in turn generated with tsl2tlsf.
